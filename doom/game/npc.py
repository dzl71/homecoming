...
class NPC(AnimatedSprite):
    ...
    def update(self):
        ...
        # self.draw_ray_cast() # 2d display

    # borrow these from player collision checking method
    ...
    def run_logic(self):
        if self.alive:  # it's alive!
            ...
            if self.pain:
                ...
                # make the npc "search" once he sees the player
    ...
    # reusing the raycasting we've already built:
    def ray_cast_player_npc(self):
        ...
        for i in range(MAX_DEPTH):
            ...
            if tile_hor == self.map_pos:  # ray is hitting the npc
        ...
        # Using what we've calculated is there line of sight?
...
# NOW THAT EVERYTHING IS WORKING, LET'S ADD SOME NPCS
