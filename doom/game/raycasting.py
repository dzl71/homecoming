...
class RayCasting:
    ...
    def get_objects_to_render(self):
        ...
        for ray, values in enumerate(self.ray_casting_result):
            ...
            else:  # player is close to the wall, need to modify projection
    ...
    def ray_cast(self):
        ...
        ray_angle = self.game.player.angle - HALF_FOV + 0.0001  # avoid x/0 errors
        for ray in range(NUM_RAYS):
            ...
            # depth -- only draw a ray as far as you need, no further
